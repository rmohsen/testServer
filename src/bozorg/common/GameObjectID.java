...
public class GameObjectID implements java.io.Serializable {
    ...
    public static bozorg.common.GameObjectID create(Class type) {
        return new bozorg.common.GameObjectID(type, NEXT++);
    }
     ...
     * @return
     */
    public static bozorg.common.GameObjectID reconstruct(String id) {
  ...
  //    System.out.println(className);
        ...
        try {
            return new bozorg.common.GameObjectID(Class.forName(className), n);
    ...
    public boolean equals(Object other) {
        ...
        bozorg.common.GameObjectID o = (bozorg.common.GameObjectID) other;
